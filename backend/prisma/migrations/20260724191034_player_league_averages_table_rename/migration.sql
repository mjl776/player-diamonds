/*
  ...
  - You are about to drop the `PlayerLeagueAverages` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropTable
DROP TABLE "PlayerLeagueAverages";

-- CreateTable
CREATE TABLE "player_league_averages" (
    "id" UUID NOT NULL,
    ...
    CONSTRAINT "player_league_averages_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "player_league_averages_season_idx" ON "player_league_averages"("season");

-- CreateIndex
CREATE UNIQUE INDEX "player_league_averages_season_season_type_key" ON "player_league_averages"("season", "season_type");
