...
def get_player_stat_rows(season: str, season_type: str) -> DataFrame:
...
def main():
    ...
    args = ap.parse_args()
    df_player_stats = get_player_stat_rows(args.season, args.season_type)
    insert_stats_to_db(df_player_stats, args.season, args.season_type)
