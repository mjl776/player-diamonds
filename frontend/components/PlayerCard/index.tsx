        ...
        <div className={styles.container}>
            <div className={styles.cardContainer}>
                ...
                <div className={styles.gameAverages}>
                    ...
                    <span> <span className={styles.averagesLabel}>Avg. Ast:</span> <span className={styles.averageStatValues}> { player.stats.ast } </span> </span>
                    <span> <span className={styles.averagesLabel}>Avg. Stl:</span> <span className={styles.averageStatValues}> { player.stats.stl } </span> </span>
                </div>
