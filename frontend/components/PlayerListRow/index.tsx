...
export const PlayerListRow: FC<PlayerStatsProps> = ({
  ...
  const { minDiff, ptsDiff, astDiff, rebDiff, stlDiff } =
  ...
  return (
    <tr className={styles.tableRow}>
      ...
      <td className={styles.tableData}>
        {avgMin}{" "}
        <span
          className={minDiff >= 0 ? styles.positiveValue : styles.negativeValue}
        >
          {" "}
          {minDiff >= 0 ? <span>+</span> : <></>}
          {minDiff}
      ...
      <td className={styles.tableData}>
        {avgPts}{" "}
        <span
          className={ptsDiff >= 0 ? styles.positiveValue : styles.negativeValue}
        >
          {" "}
          {ptsDiff >= 0 ? <span>+</span> : <></>}
          {ptsDiff}
      ...
      <td className={styles.tableData}>
        {avgAst}{" "}
        <span
          className={astDiff >= 0 ? styles.positiveValue : styles.negativeValue}
        >
          {" "}
          {astDiff >= 0 ? <span>+</span> : <></>}
          {astDiff}
      ...
      <td className={styles.tableData}>
        {avgReb}{" "}
        <span
          className={rebDiff >= 0 ? styles.positiveValue : styles.negativeValue}
        >
          {" "}
          {rebDiff >= 0 ? <span>+</span> : <></>}
          {rebDiff}
      ...
      <td className={styles.tableData}>
        {avgStl}{" "}
        <span
          className={stlDiff >= 0 ? styles.positiveValue : styles.negativeValue}
        >
          {" "}
          {stlDiff >= 0 ? <span>+</span> : <></>}
          {stlDiff}
